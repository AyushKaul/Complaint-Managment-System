...
<p align="center" style="color:#106cb5;font-size:24px;font-weight:bold;" >Complain Management System</p>
<img src="images/make-online-complaint-btn.jpg"  style="float:left;border:0px; padding:10px;"/>
<p align="left" style="line-height:24px; padding:10px;"><b>Online Complaint Management System (OCMS)</b> is a system operated by the Thakur College of Engineering (TCET). A Complaint Management System is one of latest productivity enhancement tools used widely by all organisations wherever there is a need of booking of complaints via operators and analysis of complaints which  are made or are pending.
<br/><br/>
