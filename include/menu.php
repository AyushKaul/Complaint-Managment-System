...
<div id="ddblueblockmenu">
	  <div class="menutitle">Customer Menu</div>
		  <ul>
			...
			<li><a href="<?php echo WEB_ROOT; ?>view.php?mod=customer&view=selectPlans">Help-Line Numbers </a></li>
...
?>
<div id="ddblueblockmenu">
	  <div class="menutitle">Authority Menu</div>
		  <ul>
			<li><a href="<?php echo WEB_ROOT; ?>">Welcome,&nbsp;<? echo ucwords($_SESSION['user_name']); ?></a></li>
...
<div id="ddblueblockmenu">
	  <div class="menutitle">Admin Menu</div>
		  <ul>
			...
			<li><a href="<?php echo WEB_ROOT; ?>view.php?mod=admin&view=enggDetails">Authority Details</a></li>
